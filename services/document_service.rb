...
class DocumentService
  ...
  def self.edit_document(the_id, new_name, description, category)
    if @document_modify = Document.find(id: the_id)
      ...
      raise ArgumentError, 'El Documento no se modifico correctamente, Intente nuevamente'
    end
  end
